# Data Structures and Algorithms (DSA) Course Work

This repository contains assignments and lab work from a Data Structures and Algorithms (DSA) course (COSC 202). Each folder contains implementations of various data structures and algorithms, demonstrating fundamental computer science concepts.
...
- **Trees**: Red-Black BST, Trie
- **Graphs**: DFS, connected components
- **Dynamic Programming**: String concatenation, text formatting
- **Search Algorithms**: Binary search, A* search
- **Sorting**: Merge sort with inversion counting
- **Hash-based Structures**: Hash maps, hash sets
- **Priority Queues**: Used in A* search

Each folder contains a detailed README explaining the specific data structure or algorithm implemented in that assignment.
